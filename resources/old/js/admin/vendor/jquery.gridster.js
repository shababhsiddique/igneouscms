    ...
    var defaults = {
        ...
        serialize_params: function($w, wgd) {
            return {
                col: wgd.col,
                row: wgd.row,
//                blocktitle: wgd.blocktitle,
                blocktype: wgd.blocktype,
                blockref: wgd.blockref,
                size_x: wgd.size_x,
                size_y: wgd.size_y
            };
        },
    ...
    fn.serialize = function($widgets) {
        ...
        $widgets.each($.proxy(function(i, widget) {
            ...
            result.push(this.options.serialize_params(
                ...
                result[indx].blockref = $(widget).data("blockref");
                result[indx].blocktype = $(widget).data("blocktype");
//                result[indx].blocktitle = $(widget).data("blocktitle");
    ...
    */
    fn.register_widget = function($el) {
        ...
        var wgd = {
            ...
            'blocktype': parseInt($el.attr('data-blocktype'), 10),
            'blockref': parseInt($el.attr('data-blockref'), 10),
//            'blocktitle': parseInt($el.attr('data-blocktitle'), 10),            
            'el': $el
        };
...
//                'data-blocktitle': wgd.blocktitle,
                'data-blocktype': wgd.blocktype,
                'data-blockref': wgd.blockref
            });
        }
